...
import net.gluu.erasmus.U2FActivity;
import net.gluu.erasmus.u2f.v2.cert.KeyPairGenerator;
...
import net.gluu.erasmus.u2f.v2.model.TokenEntry;
import net.gluu.erasmus.u2f.v2.store.DataStore;
import net.gluu.erasmus.u2f.v2.user.UserPresenceVerifier;
...
public class U2FKeyImpl implements U2FKey {
    ...
    public EnrollmentResponse register(EnrollmentRequest enrollmentRequest) throws U2FException {
        ...
        String authenticationType = U2FActivity.getResourceString(oneStep ? R.string.one_step : R.string.two_step);
