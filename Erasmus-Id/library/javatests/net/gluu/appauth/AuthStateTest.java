...
import static net.gluu.appauth.TestValues.TEST_ACCESS_TOKEN;
import static net.gluu.appauth.TestValues.TEST_AUTH_CODE;
import static net.gluu.appauth.TestValues.TEST_CLIENT_SECRET;
import static net.gluu.appauth.TestValues.TEST_ID_TOKEN;
import static net.gluu.appauth.TestValues.TEST_REFRESH_TOKEN;
import static net.gluu.appauth.TestValues.getMinimalAuthRequestBuilder;
import static net.gluu.appauth.TestValues.getTestAuthCodeExchangeResponse;
import static net.gluu.appauth.TestValues.getTestAuthCodeExchangeResponseBuilder;
import static net.gluu.appauth.TestValues.getTestAuthRequest;
import static net.gluu.appauth.TestValues.getTestAuthResponse;
import static net.gluu.appauth.TestValues.getTestAuthResponseBuilder;
import static net.gluu.appauth.TestValues.getTestRegistrationResponse;
import static net.gluu.appauth.TestValues.getTestRegistrationResponseBuilder;
