...
import net.gluu.appauth.AuthorizationException.RegistrationRequestErrors;
import net.gluu.appauth.AuthorizationException.TokenRequestErrors;

import net.gluu.appauth.browser.BrowserDescriptor;
import net.gluu.appauth.browser.BrowserSelector;
